...
var root = monkies["root"].GetResult();
...
class Monkey
{
    ...
    public long GetResult()
    {
        ...
        if (Shout.HasValue) return (result = Shout).Value;
        if (ExecCalc != null && Monkey1 != null && Monkey2 != null)
            return (result = ExecCalc(Monkey1.GetResult(), Monkey2.GetResult())).Value;
